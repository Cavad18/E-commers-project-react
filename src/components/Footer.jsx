    ...
    <footer className="p-5 text-light mt-5 bg-danger">
      <div className="row">
        <div className="col-12 col-sm-2">
          ...
          <p>Subscribe</p>
          <p>Get 10% off you first order</p>
          <input
            className="p-2 bg-transparent border border-light text-light"
            type="text"
        ...
        <div className="col-12 col-sm-2">
          ...
          <p>
            <small className="text-light">Save $3 with App New User Only</small>
          </p>
          <div>
